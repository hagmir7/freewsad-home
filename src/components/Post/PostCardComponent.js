        ...
        <div className="col-12 col-md-6 col-lg-4 mb-3" ref={props.last} key={props.slug} >
            <Link to={`/p/${props.slug}`}>
                <div className="img-content">
                    <img className="card-img-top m-0 p-0 border rounded" width="100%" height="100%" onLoad={(e)=> e.target.src = props.image} src='/assets/img/loading.png' alt={props.title} title={props.title} />
                </div>
            </Link>
